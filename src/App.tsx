        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="hidden md:flex items-center gap-4">
              {user ? (
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2 px-3 py-2 bg-dark-200 border border-dark-50 rounded-lg">
          ...
          <div className="md:hidden bg-dark-100 border-t border-dark-50">
            <div className="px-4 py-4 space-y-4">
              ...
              <div className="pt-4 border-t border-dark-50 flex gap-4">
                {user ? (
                  <button onClick={handleLogout} className="flex-1 py-2 text-gray-300 hover:text-white flex items-center justify-center gap-2">
                    <LogOut className="w-4 h-4" /> Выйти
                  </button>
                ) : (
                  <>
